      ...
      <div class="col-md-5 bg-slate-100 py-3 px-3 rounded-md">
        <form action="<?= base_url('admin/save'); ?>" method="post">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="bobot_kriteria" id="bobot_kriteria" class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-md py-2 px-2" required placeholder="Bobot Kriteria">
          </div>
          <div class="mt-6">
