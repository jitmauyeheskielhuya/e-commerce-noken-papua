    ...
    <section id=" home" class="pt-20 pb-16 bg-slate-100 dark:bg-slate-800">
      ...
      <div class="container">
        ...
        <div class="w-full px-1 flex flex-wrap justify-center xl:w-8/12 xl:mx-auto">
            ...
            <table class="rounded-none border-2 border-black border-solid">
              <tr class="rounded-none border-2 border-black border-solid" >
                <th class="rounded-none border-2 border-black border-solid">N Harga</th>
                <th class="rounded-none border-2 border-black border-solid">N Ukuran </th>
                <th class="rounded-none border-2 border-black border-solid">N Motif</th>
                <th class="rounded-none border-2 border-black border-solid">N Jenis</th>
              </tr>
              <?php foreach($perhitungan as $p) : ?>
                <tr>
                  <td><?= $p['n_harga']?></td>
        ...
        <div class="w-full px-1 flex flex-wrap justify-center xl:w-8/12 xl:mx-auto">
            ...
            <table class="rounded-none border-2 border-black border-solid">
              <tr class="rounded-none border-2 border-black border-solid" >
                <th class="rounded-none border-2 border-black border-solid" colspan="3">Hasil Utility X Normalisasi</th>
                
              </tr>
              <?php foreach($perhitungan as $p) : ?>
                <tr>
                  <td><?= $p['u_x_n_harga']?></td>
                  <td><?= $p['u_x_n_ukuran']?></td>
                  <td><?= $p['u_x_n_motif']?></td>
                  <td><?= $p['u_x_n_jenis']?></td>
                </tr>
              <?php endforeach ?>
        ...
        <div class="w-full pt-4">
          <div class="container mx-auto py-8 bg-slate-200 rounded-md shadow-md mb-16">
                    ...
                    <?php foreach($subkriteria as $sk): ?>
                        <?php if($sk['id_kriteria'] == $k['id_kriteria']) :?>
                          <option value="<?= $sk['id_subkriteria']?>"> 
                            <?php echo $sk['range_depan_subkriteria']; 
                            
                            if($sk['range_belakang_subkriteria'] != null && $sk['range_depan_subkriteria'] != '>' && $sk['range_depan_subkriteria'] != '<' &&  $sk['range_depan_subkriteria'] !== '' )
                            {
                              echo '-';
                            };
                            echo $sk['range_belakang_subkriteria'];
            ...
            <div class="w-64 mx-auto mt-4">
              <div class="bg-emerald-300 flex justify-center w-20 hover:bg-emerald-400 rounded-md">
